...
BOT_TOKEN = environ.get('BOT_TOKEN', "5918067901:AAFuRbUKHC4Cj3Q9RijgDwCXYFRas25flYE")


# This Pictures Is For Start Message Picture, You Can Add Multiple By Giving One Space Between Each.
PICS = (environ.get('PICS', 'https://envs.sh/pRi.jpg')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5149183428 6765929934').split()] # For Multiple Id Use One Space Between Each.
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001606185333')).split()]  # For Multiple Id Use One Space Between Each.
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://nk3442838:HW8pRS6RG71J4ycw@cluster0.6zepz1y.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
PAYMENT_QR = environ.get('PAYMENT_QR', 'https://t.me/Hindi_movie_uplod/32') # payment code picture url.
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/Hindi_movie_uplod') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'http://t.me/Kingak70')
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', '12b3417a01f54122a9e9bfb700e995abd0db8052')
